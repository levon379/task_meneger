            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('saveTask') }}">
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right">{{ __('Assign task to User') }}</label>

                            <div class="col-md-6">
                                <input id="user_id" type="text" class="form-control @error('name') is-invalid @enderror" name="user_id" value="" required autocomplete="name" autofocus>
